CREATE TABLE "TimeTrackerEnrollmentRequest" (
    ...
    "verificationPrefix" TEXT NOT NULL,
...
CREATE UNIQUE INDEX "TimeTrackerEnrollmentRequest_verificationPrefix_key" ON "TimeTrackerEnrollmentRequest"("verificationPrefix");
