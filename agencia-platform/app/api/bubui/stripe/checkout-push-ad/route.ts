/**
 * POST /api/bubui/stripe/checkout-push-ad
 *
 * Body: { businessId, title, body, radiusKm, startsAt }
 *
 * Flujo:
 * 1. Cotiza precio dinámico (lib/bubui/core dynamicPushPriceEur).
 * 2. Crea Stripe Checkout Session (pago único).
 * 3. Crea el BubuiPushAd en estado "scheduled" con pricePaidEur=quoted.
...
export async function POST(req: Request) {
  ...
  try {
    ...
    // Creamos el BubuiPushAd en estado "scheduled" (pendiente de pago).
