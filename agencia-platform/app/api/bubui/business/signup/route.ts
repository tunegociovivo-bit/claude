/**
 * POST /api/bubui/business/signup
 *
 * Registra un negocio nuevo en Bubui. Crea el slug único, hashea la
 * contraseña del dueño y devuelve el businessId + scanUrl (que es lo que
 * pondremos en el QR del cartel).
 *
 * Si el body incluye `referrerBusinessId` (porque el dueño llegó a Bubui
  ...
  return NextResponse.json(
    {
      ...
      posterUrl: `/api/bubui/business/${business.id}/poster.png`
    },
    { status: 201 }
  );
}
