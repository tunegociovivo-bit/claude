...
const { authenticateMock, prisma, regenerateDraftMock, deleteCommentMock } = vi.hoisted(() => ({
...
describe("POST /api/v1/meta-comments regenerate_draft", () => {
  ...
  it("explica el error real cuando Meta rechaza eliminar un comentario", async () => {
    ...
    deleteCommentMock.mockRejectedValue(new Error("Meta 400 en meta-1: el comentario no admite eliminación"));
