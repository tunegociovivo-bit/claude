...
/**
 * Banner de instalación PWA de Bubui.
 *
 ...
 * - Recuerda el descarte en localStorage (`bubui.installDismissed`) 14 días.
 */

import { useEffect, useState } from "react";

const DISMISS_KEY = "bubui.installDismissed";
    ...
    <div className="bubui-install-prompt fixed inset-x-0 bottom-0 z-[60] px-3 pb-3 pointer-events-none">
      <div className="max-w-md mx-auto pointer-events-auto bubui-card p-4 flex items-center gap-3 shadow-xl">
        ...
        <div className="flex-1 min-w-0">
          <div className="font-black text-sm leading-tight">Instala Bubui en tu móvil</div>
          {isIOS ? (
        ...
        {isIOS ? (
          ...
          <div className="flex items-center gap-1 shrink-0">
            ...
            <button onClick={install} className="bubui-btn text-xs px-4 py-2">
              Instalar
            </button>
          </div>
        )}
