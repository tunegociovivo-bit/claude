const TOKEN_ACCESS_ERROR =
  /unsupported get request|missing permissions?|does not exist|invalid oauth|oauth(?:access)?token|error validating access token|session has expired|\"code\"\s*:\s*190/i;
