...
export default function FacebookConversationBatchView({ batch, editable, disabled, onChange }: {
  ...
  return <div className="mt-3 space-y-3">
    ...
    {!batch.candidates.length && batch.progress.startsWith("Búsqueda terminada") && <p className="rounded-lg border border-dashed p-4 text-xs text-slate-600">No se encontraron comentarios que cumplieran los criterios en las pantallas revisadas. Consulta el alcance para ver qué grupos se pudieron leer.</p>}
